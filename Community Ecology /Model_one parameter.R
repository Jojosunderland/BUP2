...
niche.breadths <- rep(0.1,10) ##all species have the same niche width of 1
...
MC.fin.mat.pa <- as.matrix(as.data.frame((MC.fin.mat>0)*1)) ##we convert the abundance data frame into a presence-absence one to compute some indices afterwards
