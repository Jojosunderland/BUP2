...
var.par <- 25   # parameter controlling variation amongst hosts
num.draws <- 10000  # number of hosts to sample
...
var.par <- 6   # parameter controlling variation amongst hosts
...
outbreak$num.inf #produces the numbers for the specific element
outbreak$num.gens
outbreak$cumul.inf
